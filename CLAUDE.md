...
- **Runtime path**: `"...".parse::<SelectQueryString>()` — calls spargebra, returns `Result<_, QueryStringError>`. Passing the wrong query kind yields `QueryStringError::WrongKind { expected: QueryType, provided: QueryType }`.
